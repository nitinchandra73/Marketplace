...
public enum ErrorCodes {
	...
	EMPLOYER_ID_SHOULDNT_BE_PROVIDED(13208), EMPLOYER_ALREADY_EXISTS(123), EMPLOYER_DOESNT_EXIST(456), EIN_NAME_ID_MISMATCH(124), BIDDER_ID_SHOULDNT_BE_PROVIDED(125), BIDDER_DOESNT_EXIST(126), BIDDER_ALREADY_EXISTS(127);
